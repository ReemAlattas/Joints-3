...
//    CreateCylinder3(8, 0., 0., -3., 0.2, 1., -55); // Create Leg 8
    ...
    // Create the Joints
    CreateHinge(0,    1, 5,    4, 1.0, 0.0,    1, 0, 0);
    CreateHinge(1,    2, 6,    -4, 1.0, 0.0,    0, 0, 1);
    CreateHinge(2,    3, 7,    0, 1.0, 4.0,    0, 0, 1);
    CreateHinge(3,    4, 8,    0, 1.0, -4.0,    0, 0, 1);
